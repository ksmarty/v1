...
function BlockTitle({ title, desc }: { title: string; desc?: string }) {
  return (
    <div>
 ...
 * All sections are shown at once, separated by dividers.
 */
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col gap-3">
        <BlockTitle
          title="MCP servers"
          desc="External servers whose tools the agent can call."
        />
        {servers.length > 0 && (
      ...
      <div className="flex flex-col gap-3">
        <BlockTitle
          title="Skills"
          desc="Installed SkillsMP skills the agent can load. Search to install more."
        />
      ...
      <form onSubmit={(e) => void savePermissionMode(e)} className="flex flex-col gap-3">
        <BlockTitle
          title="Permissions"
          desc="Controls how the agent handles tool calls like running commands, editing files, and talking to MCP servers."
        />
